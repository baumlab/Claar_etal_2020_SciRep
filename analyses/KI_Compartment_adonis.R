...
adonis(distance(phy97.f.c.coral, method="wunifrac") ~ Coral_Species + field_season + site, data = coral.sp.metadata)
...
adonis(distance(phy97.f.c.coral, method="wunifrac") ~ Coral_Species + field_season + Dist,data = coral.sp.metadata)
