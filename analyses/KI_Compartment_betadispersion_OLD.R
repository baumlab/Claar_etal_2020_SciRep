...
boxplot(sediment.bd,col=timecols)
boxplot(water.bd,col=timecols)
dev.off()
...
par(mfrow=c(1,4))
boxplot(sediment.bd.site27,col=timecols,main="Site 27")
boxplot(sediment.bd.site30,col=timecols,main="Site 30")
boxplot(sediment.bd.site35,col=timecols,main="Site 35")
boxplot(sediment.bd.site8,col=timecols,main="Site 8")
dev.off()
...
par(mfrow=c(1,4))
boxplot(water.bd.site30,col=timecols,main="Site 27",ylim=c(0,0.06))
boxplot(water.bd.site30,col=timecols,main="Site 30",ylim=c(0,0.06))
boxplot(water.bd.site35,col=timecols,main="Site 35",ylim=c(0,0.06))
boxplot(water.bd.site8,col=timecols,main="Site 8",ylim=c(0,0.06))
dev.off()
...
boxplot(coral.bd.Mfol,col=timecols,main="Montipora",ylim=c(0,0.1))
boxplot(coral.bd.Peydo,col=timecols, main="P. eydouxi",ylim=c(0,0.1),ylab="")
boxplot(coral.bd.Plob,col=timecols, main="P. lobata",ylim=c(0,0.1),ylab="")
dev.off()
