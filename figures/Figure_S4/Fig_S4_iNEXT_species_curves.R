...
coral <- vegan_otu(phyASV.f.c.coral)
sediment <- vegan_otu(phyASV.f.c.sediment)
water <- vegan_otu(phyASV.f.c.water)
...
coral_dist <- merge_samples(phyASV.f.c.coral,"Dist")
...
coral_dist_iNEXT_gg <- ggiNEXT(coral_dist_iNEXT,type=1,se=TRUE)+
  ...
  scale_y_continuous(name="ASV Richness",expand=c(0,0),limits = ylim_coral)+
  theme_classic()+
  scale_color_manual(values=c(sitecols[["8"]],sitecols[["30"]]))+
  scale_fill_manual(values=c(sitecols[["8"]],sitecols[["30"]]))
coral_dist_iNEXT_gg

sed_dist <- merge_samples(phyASV.f.c.sediment,"Dist")
...
sed_dist_iNEXT_gg <- ggiNEXT(sed_dist_iNEXT,type=1,se=TRUE)+
  ...
  scale_y_continuous(name="ASV Richness",expand=c(0,0),limits = ylim_sed)+
  theme_classic()+
  scale_color_manual(values=c(sitecols[["8"]],sitecols[["30"]]))+
  scale_fill_manual(values=c(sitecols[["8"]],sitecols[["30"]]))

wat_dist <- merge_samples(phyASV.f.c.water,"Dist")
...
wat_dist_iNEXT_gg <- ggiNEXT(wat_dist_iNEXT,type=1,se=TRUE)+
  ...
  scale_y_continuous(name="ASV Richness",expand=c(0,0),limits = ylim_wat)+
  theme_classic()+
  scale_color_manual(values=c(sitecols[["8"]],sitecols[["30"]]))+
  scale_fill_manual(values=c(sitecols[["8"]],sitecols[["30"]]))
...
coral_site <- merge_samples(phyASV.f.c.coral,"site")
...
sed_site <- merge_samples(phyASV.f.c.sediment,"site")
...
wat_site <- merge_samples(phyASV.f.c.water,"site")
...
wat_site_iNEXT_gg <- ggiNEXT(wat_site_iNEXT,type=1,se=TRUE)+
  scale_x_continuous(name="Number of Sequences",limits = xlim_wat)+
  scale_y_continuous(name="ASV Richness",expand=c(0,0),limits = ylim_wat+c(0,30))+
  theme_classic()+
  scale_color_manual(values=c(sitecols))+
  scale_fill_manual(values=c(sitecols))

coral_field_season <- merge_samples(phyASV.f.c.coral,"field_season")
...
sed_field_season <- merge_samples(phyASV.f.c.sediment,"field_season")
...
wat_field_season <- merge_samples(phyASV.f.c.water,"field_season")
...
wat_field_season_iNEXT_gg <- ggiNEXT(wat_field_season_iNEXT,type=1,se=TRUE)+
  scale_x_continuous(name="Number of Sequences",limits = xlim_wat)+
  scale_y_continuous(name="ASV Richness",expand=c(0,0),limits = ylim_wat-c(0,15))+
  theme_classic()+
  scale_color_manual(values=c(timecols))+
  scale_fill_manual(values=c(timecols))


jpeg(filename="figures/Figure_S4/Fig_S4_coral_iNEXT_SAC.jpeg",res = 300, width = 9, height= 12,units = "in")
grid.arrange(coral_dist_iNEXT_gg,coral_site_iNEXT_gg,coral_field_season_iNEXT_gg)
dev.off()

jpeg(filename="figures/Figure_S5/Fig_S5_sediment_iNEXT_SAC.jpeg",res = 300, width = 9, height= 12,units = "in")
grid.arrange(sed_dist_iNEXT_gg,sed_site_iNEXT_gg,sed_field_season_iNEXT_gg)
dev.off()

jpeg(filename="figures/Figure_S6/Fig_S6_water_iNEXT_SAC.jpeg",res = 300, width = 9, height= 12,units = "in")
grid.arrange(wat_dist_iNEXT_gg,wat_site_iNEXT_gg,wat_field_season_iNEXT_gg)
dev.off()

pdf(file="figures/Figure_S4/Fig_S4_coral_iNEXT_SAC.pdf",width = 9, height = 12,useDingbats = FALSE)
grid.arrange(coral_dist_iNEXT_gg,coral_site_iNEXT_gg,coral_field_season_iNEXT_gg)
dev.off()

pdf(file="figures/Figure_S5/Fig_S5_sediment_iNEXT_SAC.pdf",width = 9, height = 12,useDingbats = FALSE)
grid.arrange(sed_dist_iNEXT_gg,sed_site_iNEXT_gg,sed_field_season_iNEXT_gg)
dev.off()

pdf(file="figures/Figure_S6/Fig_S6_water_iNEXT_SAC.pdf", width = 9, height = 12,useDingbats = FALSE)
grid.arrange(wat_dist_iNEXT_gg,wat_site_iNEXT_gg,wat_field_season_iNEXT_gg)
dev.off()
